...
function articleMaker({
  ...
  const article1stP = document.createElement("p");
  const article2ndP = document.createElement("p");
  const article3rdP = document.createElement("p");
  const articleExpandBtn = document.createElement("span");

  // Append elements
  article.appendChild(articleTitle);
  article.appendChild(articleDate);
  article.appendChild(article1stP);
  article.appendChild(article2ndP);
  article.appendChild(article3rdP);
  ...
  article1stP.textContent = firstParagraph;
